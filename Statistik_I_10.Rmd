...
Die Kovarianz von Schlaf und Konzentration in dieser Stichprobe berechnet sich wie folgt $(\bar{x}=8.63, \bar{y}=`r round(mean(df2[,3]),2)`)$:

$$cov_{x,y}=\frac{(6-8.63)\cdot(2-5.56)+(7-8.63)\cdot(2-5.56)+...}{`r N-1`}=`r round(cov(df2[,2], df2[,3]), 2)`$$
