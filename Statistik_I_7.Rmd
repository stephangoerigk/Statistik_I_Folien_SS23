...
4. Berechnung Teststatistik (Beobachtungswert in auf Wahrscheinlichkeitsverteilung abbilden)
  * z-Wert $\rightarrow$ Mittelwerte, wenn $\sigma$ in Population bekannt
  * t-Wert $\rightarrow$ Mittelwerte, wenn $\sigma$ in Population nicht bekannt
  * F-Wert $\rightarrow$ Varianzen
  * $\chi^2$-Wert $\rightarrow$ Häufigkeiten/Proportionen
...
$\rightarrow$ Gesamte "Unsicherheit" wird auf eine Seite gesetzt (z.B. kleiner vs. größer als 0).
...
$\rightarrow$ "Unsicherheit" wird auf beide Seiten aufgeteilt (unterschiedlich von 0).
...
* Merke: 
  * Bei gerichteten Formulierungen wie "mindestens" oder "höchstens" nutzen wir die **kumulierte Binomialverteilungstabelle**
...
* Zum Vergleich: kritischer Wert für $p=.05$ unter der Standardnormalverteilung $z_{krit}=-1.65$
