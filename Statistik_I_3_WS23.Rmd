...
.left[Formel:] $$\sigma^2=\frac{\sum\limits _{i=1}^{n}(x_{i}-\bar{x})^2}{n-1}$$
]
]
.pull-right[
.center[
...
$$n \cdot \alpha = `r n` \cdot 0.25 = `r n * 0.25` \rightarrow I_{0.25} = 6$$
$$n \cdot \alpha = `r n` \cdot 0.75 = `r n * 0.75` \rightarrow I_{0.75} = 12$$

$$q_{0.25} = x_{(I_{0.25})} = 6$$
$$q_{0.75} = x_{(I_{0.75})} = 11$$
$$q_{A}= \widetilde{x}_{0.75} - \widetilde{x}_{0.25} = 11 - 6 = 5$$
...
$$q_{0.25} = \frac{x_{(I_{0.25})} + x_{(I_{0.25}+1)}}{2} = 8.5$$
$$q_{0.75} = \frac{x_{(I_{0.75})} + x_{(I_{0.75}+1)}}{2} = 14.5$$
$$q_{A}= \widetilde{x}_{0.75} - \widetilde{x}_{0.25} = 6$$
