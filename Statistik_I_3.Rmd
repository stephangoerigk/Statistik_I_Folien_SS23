...
**Varianz $s^2$** (Stichprobe) bzw. $\sigma^2$ (Population):
...
**Standardabweichung $s$ bzw. $\sigma$**:
...
$$q_{0.25} = x_{(I_{0.25})} = 9$$
$$q_{0.75} = x_{(I_{0.75})} = 13.5$$
$$q_{A}= \widetilde{x}_{0.75} - \widetilde{x}_{0.25} = 13.5 - `r quantile(x, 0.25)` = 4.5$$
